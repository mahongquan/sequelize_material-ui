  ...
  mapfunc=(contact, idx) => {
    if (contact.name)
        return (<TableRow key={idx} >
          ...
          <TableCell><Button onClick={()=>this.handleEdit(contact.id)}>{contact.name}</Button></TableCell>
        </TableRow>);
   else
        return (<TableRow key={idx} >
          <TableCell>{contact.id}</TableCell>
          <TableCell><Button onClick={()=>this.handleEdit(contact.id)}>[NONAME]</Button></TableCell>
        </TableRow>);
