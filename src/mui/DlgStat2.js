...
logChange=(val)=> {
  ...
  render=()=>{
    ...
    return (
      ...
      <MenuItem onClick={() => this.onClickBaoxiang("马红权")}>马红权</MenuItem>
      <MenuItem onClick={() => this.onClickBaoxiang("陈旺")}>陈旺</MenuItem>
      <MenuItem onClick={() => this.onClickBaoxiang("吴振宁")}>吴振宁</MenuItem>
