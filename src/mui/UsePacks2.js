  ...
  render() {
    ...
    const usepackRows = usepacks.map((usepack, idx) => (
      ...
      >
        ...
        <TableCell>
        <Button variant="outlined" onClick={()=>this.handleEdit(idx)}>编辑</Button>
        <Button  variant="outlined" onClick={() => this.onDeleteClick(idx)} style={{marginLeft:"10px"}}>删除</Button>
        </TableCell>
      </TableRow>
    ));
    ...
    <div>
        ...
        <div style={{display:"flex",alignItems:"center"}}>
          ...
          />
        <Button   variant="outlined" style={{margin:"10px 10px 10px 10px"}} className="btn" onClick={this.bibei}>必备</Button>
      ...
      <div style={{margin:"10px 10px 10px 0px",display:"flex",alignItems:"center"}}>
        ...
        <Button  variant="outlined" className="btn btn-primary" id="id_new_usepack" onClick={this.new_pack}>新包</Button>
      </div>
