...
export default class socket{
			static post_standard=(models, data, callback )=>{
   			...
   			static get_showcontact= async function(models, data, callback ){
   				console.log(data);
			...
			static get_year12=async function(models, data, callback ) {
			...
			static get_month12= async function(models, data, callback ) {
			    var baoxiang=data.baoxiang;
			   	var end_date=new Date();
			    var start_date=new Date();//datetime.datetime(end_date.year-1,1,1,0,0,0)
			...
			static parts_showcontact=async function(models, data, callback ) {	
				var contact = await models.Contact.findById(data.id); //.then(function(packitem) {
				callback({
					data: contact,
			...
			static delete_Contact= async function(models, data, callback ) {	
			...
			static post_Contact= async function(models, data, callback ) {		
				let  contact;
				try{
			...
			static put_Contact=async function(models, data, callback ) {			
				var contact = await models.Contact.findById(data.id); //.then(function(packitem) {
				contact.update(data);
				contact.save();
				callback({
			...
			static get_Contact= async function(models, data, callback ) {				
			...
			static delete_UsePack= async function(models, data, callback ) {				
			...
			static post_UsePack=async function(models, data, callback ) {				
				var data1={};
